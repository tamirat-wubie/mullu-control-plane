...
Invariants:
  - Authority admission dossier can become ready for operator decision only.
  - Authority admission dossier does not register loops.
...
def test_authority_admission_dossier_is_ready_only_for_operator_decision() -> None:
    dossier = reporter.build_dossier()
