...
def test_github_pr_terminal_closure_operator_decision_value_request_rejects_command_preview_generic_rejection_drift(
    ...
    payload = build_mutated_operator_decision_value_request(
        ...
        command_preview_generic_rejection_evidence__command_preview_terminal_closure_certificate_witness_ref=(
            "examples/other-certificate.json"
        ),
        command_preview_generic_rejection_evidence__command_preview_operator_response_binding_ref=(
            "examples/other-response-binding.json"
        ),
        command_preview_generic_rejection_evidence__command_preview_operator_approval_request_binding_ref=(
            "examples/other-approval-binding.json"
        ),
        command_preview_generic_rejection_evidence__command_preview_ref="examples/other-preview.json",
        command_preview_generic_rejection_evidence__redacted_command_preview="gh pr create --body leaked",
    ...
    assert (
        "command_preview_generic_rejection_evidence.requires_command_preview_generic_rejection_evidence must be true"
        in serialized_errors
    )
    assert (
        "command_preview_generic_rejection_evidence.requires_command_preview_operator_approval_gate_evidence must be true"
        in serialized_errors
    )
    assert (
        "command_preview_generic_rejection_evidence.command_preview_terminal_closure_certificate_witness_ref expected"
        in serialized_errors
    )
    ...
    assert (
        "command_preview_generic_rejection_evidence.command_preview_operator_approval_request_binding_ref expected"
        in serialized_errors
    )
