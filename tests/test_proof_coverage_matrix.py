...
def test_witness_integrity_report_tracks_exact_test_anchors() -> None:
    ...
    assert surfaces["operator_console_read_models"]["exact_test_anchor_count"] == 12
...
def test_holistic_loop_kernel_witness_labels_have_exact_anchors() -> None:
    ...
    assert holistic_integrity["runtime_witness_count"] == 33
    assert holistic_integrity["exact_test_anchor_count"] == 33
