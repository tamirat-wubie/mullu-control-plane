...
def test_witness_integrity_report_tracks_exact_test_anchors() -> None:
    ...
    assert surfaces["assistant_kernel_planning"]["exact_test_anchor_count"] == 14
    ...
    assert surfaces["governed_connector_framework"]["exact_test_anchor_count"] == 97
...
def test_governed_connector_framework_surface_gates_invocation_lifecycle() -> None:
    ...
    assert connector_witness_surface["exact_test_anchor_count"] == 97
