...
def test_representative_routes_are_not_unclassified() -> None:
    ...
    assert classified_routes["/api/v1/multi-agent/conflicts/unresolved"]["surface_id"] == "multi_agent_coordination_runtime"
...
def test_multi_agent_coordination_runtime_surface_is_witnessed() -> None:
    ...
    assert "mcoi/mcoi_runtime/app/routers/deps.py" in multi_agent_surface["evidence_files"]
    ...
    assert "multi_agent_delegation_recorded" in witnesses
    assert "multi_agent_delegation_resolution_bounded" in witnesses
    assert "multi_agent_handoff_preserves_context" in witnesses
    assert "multi_agent_merge_decision_recorded" in witnesses
    assert "multi_agent_conflict_recorded" in witnesses
    assert "multi_agent_read_models_bounded" in witnesses
