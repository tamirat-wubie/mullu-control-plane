...
def test_witness_integrity_report_tracks_exact_test_anchors() -> None:
    ...
    assert surfaces["operator_console_read_models"]["exact_test_anchor_count"] == 23
...
def test_representative_routes_are_not_unclassified() -> None:
    ...
    assert (
        classified_routes["/api/v1/personal-assistant/approval-proposals/from-draft/preview"]["surface_id"]
        == "assistant_kernel_planning"
    )
    assert (
        classified_routes["/api/v1/personal-assistant/send-write/eligibility/preview"]["surface_id"]
        == "assistant_kernel_planning"
    )
    assert (
...
def test_orgos_case_governance_lifecycle_surface_is_proven() -> None:
    ...
    assert witness_records["orgos_case_governance_lifecycle"]["exact_test_anchor_count"] == 76
