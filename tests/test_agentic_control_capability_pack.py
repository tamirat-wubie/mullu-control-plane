...
incident-recovery planning, code-change planning, telemetry-triage planning,
release-handoff planning, and append-only evidence ledger capability boundaries.
...
def test_agentic_control_pack_installs_through_explicit_capability_fabric() -> None:
    ...
    assert read_model["capability_count"] == 17
...
def test_agentic_control_governed_records_bind_planning_and_ledger_boundaries() -> None:
    ...
    telemetry_record = governed["agentic_control.telemetry_triage.plan"]
