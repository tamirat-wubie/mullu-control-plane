...
def test_github_pr_terminal_closure_operator_decision_contract_rejects_command_preview_approval_gate_drift() -> None:
    payload = validator.build_mutated_terminal_closure_operator_decision_contract(
        ...
        decision_contract__command_preview_approval_gate_evidence__requires_command_preview_terminal_closure_certificate_witness=False,
        ...
        decision_contract__command_preview_approval_gate_evidence__command_preview_ref="examples/other-preview.json",
        decision_contract__command_preview_approval_gate_evidence__redacted_command_preview="gh pr create --body leaked",
        decision_contract__command_preview_approval_gate_evidence__command_preview_bound=False,
    )
    ...
    assert "decision_contract.command_preview_approval_gate_evidence.source_approval_gate_binding_id expected" in serialized_errors
    ...
    assert "decision_contract.command_preview_approval_gate_evidence.requires_command_preview_terminal_closure_certificate_witness must be true" in serialized_errors
    assert "decision_contract.command_preview_approval_gate_evidence.command_preview_terminal_closure_certificate_witness_ref expected" in serialized_errors
    assert "decision_contract.command_preview_approval_gate_evidence.command_preview_effect_reconciliation_witness_ref expected" in serialized_errors
    assert "decision_contract.command_preview_approval_gate_evidence.command_preview_operator_response_binding_ref expected" in serialized_errors
    assert "decision_contract.command_preview_approval_gate_evidence.command_preview_operator_approval_request_binding_ref expected" in serialized_errors
    ...
    assert "decision_contract.command_preview_approval_gate_evidence.command_preview_bound must be true" in serialized_errors
