...
def test_maf_runtime_binding_admission_witness_security_review_passes_strict() -> None:
    review_path = Path("examples/sdlc/security_review_maf_runtime_binding_admission_witness_20260618.json")
    review = validate_sdlc_artifact.load_json_object(review_path, "maf runtime binding admission security review")
