...
def _ready_report() -> dict[str, object]:
    return {
        ...
        "steps": [
            ...
            {"detail": "ok=true action_count=13 approval_required_action_count=4 source_plan_types=['adapter', 'deployment']", "name": "closure plan schema validation", "passed": True},
            {"detail": "ok=true expected_action_count=13 observed_action_count=13 expected_approval_required_count=4 observed_approval_required_count=4", "name": "closure plan drift validation", "passed": True},
