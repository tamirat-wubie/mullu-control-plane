"""Tests for governed swarm and note-memory package metadata.
...
Dependencies: mcoi/pyproject.toml and control-plane handoff docs.
...
def test_governed_swarm_and_note_console_entry_points_are_guarded() -> None:
