...
def test_llm_provider_declares_hosted_provider_mesh() -> None:
    expected_providers = {
        ...
        LLMProvider.PACKET,
        LLMProvider.RIDVAY,
        LLMProvider.NEUROROUTERS,
        LLMProvider.GLAMA,
        LLMProvider.GMI,
        LLMProvider.ATLASCLOUD,
        LLMProvider.MODELMAX,
        LLMProvider.VENICE,
        LLMProvider.EURI,
        LLMProvider.APIROUTER,
        LLMProvider.QUICKSILVER,
        LLMProvider.MIXLAYER,
        LLMProvider.APILINK,
        ...
        LLMProvider.EMBERCLOUD,
        LLMProvider.MORPHEUS,
        LLMProvider.INFERENCENET,
        LLMProvider.ANSWIRA,
        LLMProvider.LLMAI,
        LLMProvider.REQUESTY,
        LLMProvider.HUGGINGFACE,
        LLMProvider.BASETEN,
        LLMProvider.HAIMAKER,
        LLMProvider.GROK,
        LLMProvider.MISTRAL,
