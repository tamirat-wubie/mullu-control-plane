...
def test_component_read_model_builds_registry_router_proof_projection() -> None:
    ...
    assert read_model["summary"]["route_family_classification_count"] == 80
    assert read_model["summary"]["classified_declared_route_count"] == 455
...
def test_component_read_model_blocks_live_authority() -> None:
    ...
    assert payload["summary"]["classified_declared_route_count"] == 455
