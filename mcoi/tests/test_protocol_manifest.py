...
def test_protocol_manifest_is_valid() -> None:
    ...
    collaboration_case_entry = entries["collaboration-case"]
    ...
    assert collaboration_case_entry["path"] == "schemas/collaboration_case.schema.json"
    assert collaboration_case_entry["urn"] == "urn:mullusi:schema:collaboration-case:1"
    assert collaboration_case_entry["surface"] == "collaboration"
