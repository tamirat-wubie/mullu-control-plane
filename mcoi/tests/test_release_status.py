...
def test_discover_release_status_summary_exposes_live_inventory() -> None:
    ...
    assert (
        "integration/contracts_compat/fixtures/mcoi_runtime/identity_record.json"
        in summary.mcoi_runtime_fixtures
    )
    assert (
        "integration/contracts_compat/fixtures/mcoi_runtime/role_record.json"
        in summary.mcoi_runtime_fixtures
    )
    assert (
        "integration/contracts_compat/fixtures/mcoi_runtime/permission_rule.json"
        in summary.mcoi_runtime_fixtures
    )
    assert (
        "integration/contracts_compat/fixtures/mcoi_runtime/role_binding.json"
        in summary.mcoi_runtime_fixtures
    )
    assert (
        "integration/contracts_compat/fixtures/mcoi_runtime/delegation_record.json"
        in summary.mcoi_runtime_fixtures
    )
    assert (
        "integration/contracts_compat/fixtures/mcoi_runtime/access_request.json"
        in summary.mcoi_runtime_fixtures
    )
    assert (
        "integration/contracts_compat/fixtures/mcoi_runtime/access_evaluation.json"
        in summary.mcoi_runtime_fixtures
    )
    assert (
        "integration/contracts_compat/fixtures/mcoi_runtime/access_violation.json"
        in summary.mcoi_runtime_fixtures
    )
    assert (
        "integration/contracts_compat/fixtures/mcoi_runtime/access_snapshot.json"
        in summary.mcoi_runtime_fixtures
    )
    assert (
        "integration/contracts_compat/fixtures/mcoi_runtime/access_audit_record.json"
        in summary.mcoi_runtime_fixtures
    )
    assert (
    ...
    assert (
        "integration/contracts_compat/fixtures/mcoi_runtime/constraint_definition.json"
        in summary.mcoi_runtime_fixtures
    )
    assert (
        "integration/contracts_compat/fixtures/mcoi_runtime/solver_problem.json"
        in summary.mcoi_runtime_fixtures
    )
    assert (
        "integration/contracts_compat/fixtures/mcoi_runtime/solver_solution.json"
        in summary.mcoi_runtime_fixtures
    )
    assert (
        "integration/contracts_compat/fixtures/mcoi_runtime/graph_node.json"
        in summary.mcoi_runtime_fixtures
    )
    assert (
        "integration/contracts_compat/fixtures/mcoi_runtime/graph_edge.json"
        in summary.mcoi_runtime_fixtures
    )
    assert (
        "integration/contracts_compat/fixtures/mcoi_runtime/schedule_slot.json"
        in summary.mcoi_runtime_fixtures
    )
    assert (
        "integration/contracts_compat/fixtures/mcoi_runtime/assignment_record.json"
        in summary.mcoi_runtime_fixtures
    )
    assert (
        "integration/contracts_compat/fixtures/mcoi_runtime/dependency_chain.json"
        in summary.mcoi_runtime_fixtures
    )
    assert (
        "integration/contracts_compat/fixtures/mcoi_runtime/constraint_snapshot.json"
        in summary.mcoi_runtime_fixtures
    )
    assert (
        "integration/contracts_compat/fixtures/mcoi_runtime/constraint_closure_report.json"
        in summary.mcoi_runtime_fixtures
    )
    assert (
...
def test_validate_release_status_strictly() -> None:
    ...
    assert len(summary.mcoi_runtime_fixtures) >= 229
