"""Purpose: verify policy, app, HTTP, and lifecycle helper contracts for the governed server.
Governance scope: boundary helper validation tests only.
Dependencies: server boundary helpers, FastAPI test client, and pytest monkeypatch support.
