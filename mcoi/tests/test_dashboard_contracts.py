...
class TestNoteMemorySummary:
    ...
    def test_unknown_retrieval_filter_mode_raises(self) -> None:
    ...
    def test_unfiltered_mode_rejects_influence_reduction(self) -> None:
        with pytest.raises(ValueError, match="unfiltered retrieval_filter_mode"):
            _note_summary(
                retrieval_influence_count=1,
    ...
    def test_unfiltered_mode_rejects_receipt_reduction(self) -> None:
        with pytest.raises(ValueError, match="unfiltered retrieval_filter_mode"):
            _note_summary(
    ...
    def test_negative_retrieval_receipt_total_count_raises(self) -> None:
        with pytest.raises(ValueError, match="retrieval_receipt_total_count"):
            _note_summary(retrieval_receipt_total_count=-1)
