...
PLAYBOOKS = {
    "regulated_ops": SalesPlaybook(
        ...
        (("How is this different from our GRC tool?", "We augment, not replace. We add symbolic evidence retrieval, governed copilot, and automated reporting on top of your existing data."),
    ...
    "enterprise_service": SalesPlaybook(
        ...
        (("How does this compare to ServiceNow?", "We complement ITSM tools with symbolic case management, evidence retrieval, and governed copilot."),
