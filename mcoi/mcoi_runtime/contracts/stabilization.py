"""Purpose: typed stabilization references for reserved operator-loop surfaces.
Governance scope: identifier-level runtime typing only.
Dependencies: trace and goal identifiers.
Invariants: stabilization state remains explicit and bounded.
"""
...
class StabilizationRecord(ContractRecord):
    ...
    def __post_init__(self) -> None:
        for field_name in ("stabilization_id", "goal_id", "trace_id"):
