...
def default_skill_descriptors() -> tuple[SkillDescriptor, ...]:
    ...
    return (
        ...
        _agentic_control_approval_governor_skill(),
        ...
        _agentic_control_execution_governor_skill(),
...
def _agentic_control_product_governor_skill() -> SkillDescriptor:
    skill_id = "agentic_control.product_governor.v1"
    return SkillDescriptor(
        skill_id=skill_id,
        name="Agentic product governor",
        skill_class=SkillClass.COMPOSITE,
        effect_class=EffectClass.EXTERNAL_READ,
        determinism_class=DeterminismClass.INPUT_BOUNDED,
        trust_class=TrustClass.TRUSTED_INTERNAL,
        ...
        steps=(
            SkillStep(
                step_id="define_product_boundary",
                name="Define product boundary",
                action_type="agentic_control.mission.define",
                output_keys=("mission_contract_ref", "product_boundary_ref", "halt_conditions"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="rank_product_questions",
                name="Rank product questions",
                action_type="agentic_control.priority.rank",
                depends_on=("define_product_boundary",),
                input_bindings={"mission_contract_ref": "define_product_boundary.mission_contract_ref"},
                output_keys=("product_question_order_ref", "dependency_blockers", "risk_weights"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="evaluate_product_governance",
                name="Evaluate product governance",
                action_type="agentic_control.governance_gate.evaluate",
                depends_on=("rank_product_questions",),
                input_bindings={"priority_order_ref": "rank_product_questions.product_question_order_ref"},
                output_keys=("gate_decision_ref", "proof_state", "blocked_actions"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="bound_product_budget",
                name="Bound product budget",
                action_type="agentic_control.resource_budget.bound",
                depends_on=("evaluate_product_governance",),
                input_bindings={"gate_decision_ref": "evaluate_product_governance.gate_decision_ref"},
                output_keys=("budget_envelope_ref", "halt_thresholds", "resource_floor"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                ...
                action_type="agentic_control.product_management.plan",
                depends_on=("bound_product_budget",),
                input_bindings={
                    "product_boundary_ref": "define_product_boundary.product_boundary_ref",
                    "gate_decision_ref": "evaluate_product_governance.gate_decision_ref",
                    "budget_envelope_ref": "bound_product_budget.budget_envelope_ref",
                },
                output_keys=("product_plan_ref", "success_metrics", "handoff_risks"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="plan_product_verification",
                name="Plan product verification",
                action_type="agentic_control.verification.plan",
                depends_on=("plan_product_management",),
                input_bindings={"product_plan_ref": "plan_product_management.product_plan_ref"},
                output_keys=("product_verification_plan_ref", "required_gates", "closure_rule"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="plan_product_interrogation",
                name="Plan product interrogation",
                action_type="agentic_control.interrogation.plan",
                depends_on=("plan_product_verification",),
                input_bindings={"verification_plan_ref": "plan_product_verification.product_verification_plan_ref"},
                output_keys=("product_interrogation_plan_ref", "unknowns", "evidence_requests"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="refine_product_gaps",
                name="Refine product gaps",
                action_type="agentic_control.self_audit.refine",
                depends_on=("plan_product_interrogation",),
                input_bindings={
                    "product_plan_ref": "plan_product_management.product_plan_ref",
                    "verification_plan_ref": "plan_product_verification.product_verification_plan_ref",
                    "interrogation_plan_ref": "plan_product_interrogation.product_interrogation_plan_ref",
                },
                output_keys=("product_refinement_plan_ref", "gap_closure_order", "residual_risk"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="plan_product_memory_admission",
                name="Plan product memory admission",
                action_type="agentic_control.memory_admission.plan",
                depends_on=("refine_product_gaps",),
                input_bindings={"refinement_plan_ref": "refine_product_gaps.product_refinement_plan_ref"},
                output_keys=("memory_admission_plan_ref", "redaction_plan_ref", "forget_path_ref"),
                provider_class_required="agentic_control_plane",
            ),
        ),
        provider_requirements=("agentic_control_plane",),
        description=(
            "Composes product boundary definition, priority ranking, governance "
            "gating, budget bounding, product management planning, verification, "
            "interrogation, product-gap refinement, and memory-admission planning "
            "before implementation or release authority is selected."
        ),
        confidence=0.25,
        metadata={
            **_NO_NEW_AUTHORITY,
            "risk_floor": "medium",
            "product_governor": True,
            "product_surfaces": (
...
def _agentic_control_approval_governor_skill() -> SkillDescriptor:
    skill_id = "agentic_control.approval_governor.v1"
    return SkillDescriptor(
        skill_id=skill_id,
        name="Agentic approval governor",
        skill_class=SkillClass.COMPOSITE,
        effect_class=EffectClass.EXTERNAL_READ,
        determinism_class=DeterminismClass.INPUT_BOUNDED,
        trust_class=TrustClass.TRUSTED_INTERNAL,
        ...
        steps=(
            SkillStep(
                step_id="define_approval_boundary",
                name="Define approval boundary",
                action_type="agentic_control.mission.define",
                output_keys=("mission_contract_ref", "approval_boundary_ref", "halt_conditions"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="rank_approval_constraints",
                name="Rank approval constraints",
                action_type="agentic_control.priority.rank",
                depends_on=("define_approval_boundary",),
                input_bindings={"mission_contract_ref": "define_approval_boundary.mission_contract_ref"},
                output_keys=("approval_constraint_order_ref", "dependency_blockers", "risk_weights"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="evaluate_approval_governance",
                name="Evaluate approval governance",
                action_type="agentic_control.governance_gate.evaluate",
                depends_on=("rank_approval_constraints",),
                input_bindings={"priority_order_ref": "rank_approval_constraints.approval_constraint_order_ref"},
                output_keys=("gate_decision_ref", "proof_state", "blocked_actions", "approval_requirements"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="bound_approval_budget",
                name="Bound approval budget",
                action_type="agentic_control.resource_budget.bound",
                depends_on=("evaluate_approval_governance",),
                input_bindings={"gate_decision_ref": "evaluate_approval_governance.gate_decision_ref"},
                output_keys=("budget_envelope_ref", "halt_thresholds", "resource_floor"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="plan_approval_verification",
                name="Plan approval verification",
                action_type="agentic_control.verification.plan",
                depends_on=("bound_approval_budget",),
                input_bindings={
                    "approval_boundary_ref": "define_approval_boundary.approval_boundary_ref",
                    "approval_requirements": "evaluate_approval_governance.approval_requirements",
                    "budget_envelope_ref": "bound_approval_budget.budget_envelope_ref",
                },
                output_keys=("approval_verification_plan_ref", "required_roles", "closure_rule"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="plan_approval_interrogation",
                name="Plan approval interrogation",
                action_type="agentic_control.interrogation.plan",
                depends_on=("plan_approval_verification",),
                input_bindings={"verification_plan_ref": "plan_approval_verification.approval_verification_plan_ref"},
                output_keys=("approval_interrogation_plan_ref", "unknowns", "evidence_requests"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="refine_approval_gaps",
                name="Refine approval gaps",
                action_type="agentic_control.self_audit.refine",
                depends_on=("plan_approval_interrogation",),
                input_bindings={
                    "approval_boundary_ref": "define_approval_boundary.approval_boundary_ref",
                    "approval_requirements": "evaluate_approval_governance.approval_requirements",
                    "verification_plan_ref": "plan_approval_verification.approval_verification_plan_ref",
                    "interrogation_plan_ref": "plan_approval_interrogation.approval_interrogation_plan_ref",
                },
                output_keys=("approval_refinement_plan_ref", "gap_closure_order", "residual_risk"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="plan_approval_memory_admission",
                name="Plan approval memory admission",
                action_type="agentic_control.memory_admission.plan",
                depends_on=("refine_approval_gaps",),
                input_bindings={"refinement_plan_ref": "refine_approval_gaps.approval_refinement_plan_ref"},
                output_keys=("memory_admission_plan_ref", "redaction_plan_ref", "forget_path_ref"),
                provider_class_required="agentic_control_plane",
            ),
        ),
        provider_requirements=("agentic_control_plane",),
        description=(
            "Composes read-only approval governance by linking approval boundary, "
            "constraint ranking, governance gate approval requirements, resource "
            "budget, role verification, interrogation, refinement, and "
            "memory-admission planning before temporal, execution, or "
            "write-capable autonomous operations."
        ),
        confidence=0.25,
        metadata={
            **_NO_NEW_AUTHORITY,
            "risk_floor": "medium",
            "approval_governor": True,
            "approval_surfaces": (
...
def _agentic_control_execution_governor_skill() -> SkillDescriptor:
    skill_id = "agentic_control.execution_governor.v1"
    return SkillDescriptor(
        skill_id=skill_id,
        name="Agentic execution governor",
        skill_class=SkillClass.COMPOSITE,
        effect_class=EffectClass.EXTERNAL_READ,
        determinism_class=DeterminismClass.INPUT_BOUNDED,
        trust_class=TrustClass.TRUSTED_INTERNAL,
        ...
        steps=(
            SkillStep(
                step_id="define_execution_boundary",
                name="Define execution boundary",
                action_type="agentic_control.mission.define",
                output_keys=("mission_contract_ref", "execution_boundary_ref", "halt_conditions"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="rank_execution_constraints",
                name="Rank execution constraints",
                action_type="agentic_control.priority.rank",
                depends_on=("define_execution_boundary",),
                input_bindings={"mission_contract_ref": "define_execution_boundary.mission_contract_ref"},
                output_keys=("execution_constraint_order_ref", "dependency_blockers", "risk_weights"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="evaluate_execution_governance",
                name="Evaluate execution governance",
                action_type="agentic_control.governance_gate.evaluate",
                depends_on=("rank_execution_constraints",),
                input_bindings={"priority_order_ref": "rank_execution_constraints.execution_constraint_order_ref"},
                output_keys=("gate_decision_ref", "proof_state", "blocked_actions"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                ...
                name="Bound execution budget",
                action_type="agentic_control.resource_budget.bound",
                depends_on=("evaluate_execution_governance",),
                input_bindings={"gate_decision_ref": "evaluate_execution_governance.gate_decision_ref"},
                output_keys=("budget_envelope_ref", "halt_thresholds", "resource_floor"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="plan_execution_change_boundary",
                name="Plan execution change boundary",
                action_type="agentic_control.code_change.plan",
                depends_on=("bound_execution_budget",),
                input_bindings={
                    "execution_boundary_ref": "define_execution_boundary.execution_boundary_ref",
                    "gate_decision_ref": "evaluate_execution_governance.gate_decision_ref",
                    "budget_envelope_ref": "bound_execution_budget.budget_envelope_ref",
                },
                output_keys=("execution_plan_ref", "change_boundary", "test_contract", "rollback_plan"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="plan_execution_recovery",
                name="Plan execution recovery",
                action_type="agentic_control.incident_recovery.plan",
                depends_on=("plan_execution_change_boundary",),
                input_bindings={
                    "execution_plan_ref": "plan_execution_change_boundary.execution_plan_ref",
                    "rollback_plan": "plan_execution_change_boundary.rollback_plan",
                    "budget_envelope_ref": "bound_execution_budget.budget_envelope_ref",
                },
                output_keys=("incident_recovery_plan_ref", "containment_actions", "verification_steps"),
                provider_class_required="agentic_control_plane",
            ...
            SkillStep(
                step_id="plan_execution_verification",
                name="Plan execution verification",
                action_type="agentic_control.verification.plan",
                depends_on=("plan_execution_change_boundary", "plan_execution_recovery"),
                input_bindings={
                    "execution_plan_ref": "plan_execution_change_boundary.execution_plan_ref",
                    "rollback_plan": "plan_execution_change_boundary.rollback_plan",
                    "incident_recovery_plan_ref": "plan_execution_recovery.incident_recovery_plan_ref",
                },
                output_keys=("execution_verification_plan_ref", "required_gates", "closure_rule"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="plan_execution_interrogation",
                name="Plan execution interrogation",
                action_type="agentic_control.interrogation.plan",
                depends_on=("plan_execution_verification",),
                input_bindings={"verification_plan_ref": "plan_execution_verification.execution_verification_plan_ref"},
                output_keys=("execution_interrogation_plan_ref", "unknowns", "evidence_requests"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="refine_execution_gaps",
                name="Refine execution gaps",
                action_type="agentic_control.self_audit.refine",
                depends_on=("plan_execution_interrogation",),
                input_bindings={
                    "execution_plan_ref": "plan_execution_change_boundary.execution_plan_ref",
                    "rollback_plan": "plan_execution_change_boundary.rollback_plan",
                    "verification_plan_ref": "plan_execution_verification.execution_verification_plan_ref",
                    "interrogation_plan_ref": "plan_execution_interrogation.execution_interrogation_plan_ref",
                    "incident_recovery_plan_ref": "plan_execution_recovery.incident_recovery_plan_ref",
                },
                output_keys=("execution_refinement_plan_ref", "gap_closure_order", "residual_risk"),
                provider_class_required="agentic_control_plane",
            ),
            SkillStep(
                step_id="plan_execution_memory_admission",
                name="Plan execution memory admission",
                action_type="agentic_control.memory_admission.plan",
                depends_on=("refine_execution_gaps",),
                input_bindings={"refinement_plan_ref": "refine_execution_gaps.execution_refinement_plan_ref"},
                output_keys=("memory_admission_plan_ref", "redaction_plan_ref", "forget_path_ref"),
                provider_class_required="agentic_control_plane",
            ),
        ),
        provider_requirements=("agentic_control_plane",),
        description=(
            "Composes read-only execution governance by linking execution boundary, "
            "constraint ranking, governance gate, resource budget, change boundary, "
            "rollback and incident recovery planning, verification, interrogation, "
            "refinement, and memory-admission planning before dispatch or evidence "
            "ledger mutation."
        ),
        confidence=0.25,
        metadata={
