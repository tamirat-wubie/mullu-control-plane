...
def build_gateway_spatial_map(readiness_checks: Mapping[str, bool]) -> SpatialMap:
    ...
    entities = (
        ...
        SpatialEntity("production_health_declaration", "public_health_claim", "production_health_zone"),
        ...
        SpatialEntity("recovery_controller", "rollback_runtime", "recovery_zone"),
        SpatialEntity("proof_verifier", "proof_runtime", "proof_verification_zone"),
        SpatialEntity("audit_chain_verifier", "audit_integrity_runtime", "audit_chain_zone"),
        SpatialEntity(
            "runtime_conformance_verifier",
            "runtime_conformance_runtime",
            "runtime_conformance_zone",
        ),
    ...
    regions = (
        ...
        SpatialRegion("production_health_zone", "public_health_boundary", "external_evidence_required"),
        ...
        SpatialRegion("recovery_zone", "rollback_recovery_boundary", "guarded"),
        SpatialRegion("proof_verification_zone", "proof_boundary", "guarded"),
        SpatialRegion("audit_chain_zone", "audit_integrity_boundary", "guarded"),
        SpatialRegion("runtime_conformance_zone", "runtime_conformance_boundary", "guarded"),
    ...
    boundaries = (
        ...
        SpatialBoundary(
            "production_health",
            ("readiness_zone", "production_health_zone"),
            BoundaryRule.REQUIRES_EVIDENCE,
        ),
        ...
        SpatialBoundary("recovery", ("api_boundary", "recovery_zone"), BoundaryRule.REQUIRES_EVIDENCE),
        SpatialBoundary("proof_verification", ("api_boundary", "proof_verification_zone"), BoundaryRule.REQUIRES_EVIDENCE),
        SpatialBoundary("audit_chain", ("api_boundary", "audit_chain_zone"), BoundaryRule.REQUIRES_EVIDENCE),
        SpatialBoundary(
            "runtime_conformance",
            ("api_boundary", "runtime_conformance_zone"),
            BoundaryRule.REQUIRES_EVIDENCE,
        ),
    ...
    paths = (
        ...
        SpatialPath("rollback_recovery_path", "gateway_api", "recovery_controller", ("recovery",)),
        SpatialPath("proof_verification_path", "gateway_api", "proof_verifier", ("proof_verification",)),
        SpatialPath("audit_chain_verification_path", "gateway_api", "audit_chain_verifier", ("audit_chain",)),
        SpatialPath(
    ...
    return SpatialMap(
        ...
        witness=(
            ...
            "production_health_declaration_requires_live_health_evidence_before_public_claims",
            ...
            "rollback_recovery_path_requires_recovery_evidence_before_effect_claims",
            "proof_verification_path_requires_evidence_before_proof_claims",
            "audit_chain_verification_path_requires_integrity_evidence_before_audit_claims",
            "runtime_conformance_path_requires_runtime_evidence_before_conformance_claims",
