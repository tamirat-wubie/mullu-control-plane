    ...
    return {
        ...
        "operator_presentation": {
            ...
            "cannot_do_in_demo": [
                ...
                "read or mutate a mailbox",
                "send external messages",
                "write repositories",
                "dispatch workers",
                "append live receipts",
        ...
        "pr_2058_review_decision": {
            ...
            "close_allowed": False,
            "reason": (
                "PR #2058 is no-effect governance evidence, but remote workflow "
                "and signed runtime authorization evidence remain AwaitingEvidence."
            ),
