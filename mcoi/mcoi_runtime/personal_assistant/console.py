    ...
    *,
    ...
    return {
        ...
        "operator_presentation": {
            "headline": "Mullu can show assistant readiness and draft next steps without taking effects.",
            "can_show": [
                "assistant_readiness",
                "skill_catalog",
            ...
            "promotion_evidence_required": [
                "signed_operator_identity",
                "approval_expiry",
                "revocation_path",
                "bounded_approval_scope",
                "replay_protection",
                "separate_activation_gate",
            ],
        },
        "dashboard_projection": {
            "projection_id": "agentic_service_harness_operator_dashboard_projection",
            "source_contract_ref": "examples/agentic_service_harness_read_models.foundation.json",
            "status_route_ref": "/api/v1/harness/status",
            "read_only": True,
            "fixture_backed": True,
            ...
            "visible_panels": [
                ...
                "dry_run_receipts",
                "closure_evidence",
                "inceptadive_advisory",
            ],
        },
        "demo_scenario": {
            "scenario_id": "team_assistant_fixture_backed_dry_run_v0",
            "operator_ask": "Show assistant readiness, draft one shared-inbox reply, and explain why sending is blocked.",
            "fixture_refs": fixture_refs,
            "draft_preview": {
                "source_ref": "examples/personal_assistant_draft_projection.json",
                "route_ref": "/api/v1/personal-assistant/drafts/email/preview",
                "preview_only": True,
                "external_send_allowed": False,
                "mailbox_mutation_allowed": False,
            },
            "approval_preview": {
                "source_ref": "examples/personal_assistant_approval_queue_read_model.json",
                "route_ref": "/api/v1/personal-assistant/approval-queue/preview",
                "preview_only": True,
                "approval_is_execution": False,
                "signed_runtime_authority_present": False,
            },
            "dry_run_receipt_trail": {
                "source_refs": [
                    "examples/agentic_service_harness.dry_run.json",
                ...
                "live_receipt_append_performed": False,
                "actions_not_taken_recorded": True,
            },
            "closure_evidence": {
                "terminal_closure_ref": "pull_request:#1741",
                "issue_ref": "github://tamirat-wubie/mullu-control-plane/issues/2067",
                "closure_claim": "demo_read_model_only",
        ...
        "workflow_separation": [
            {
                "phase": "observation",
                "state": "read_model_projection",
                "source_ref": "examples/agentic_service_harness_read_models.foundation.json",
                "effect_allowed": False,
            },
            {
                "phase": "proposal",
                "state": "fixture_backed_draft_preview",
                "source_ref": "examples/personal_assistant_draft_projection.json",
                "effect_allowed": False,
            },
            {
                "phase": "approval",
                "state": "approval_preview_only",
                "source_ref": "examples/personal_assistant_approval_queue_read_model.json",
                "approval_is_execution": False,
                "effect_allowed": False,
            },
            {
                "phase": "execution",
                "state": "blocked_no_effect",
                "source_ref": "examples/agentic_service_harness.blocked_high_risk.json",
                "effect_allowed": False,
            },
            {
                "phase": "closure",
                "state": "dry_run_evidence_only",
                "source_ref": "examples/personal_assistant_readiness_index_receipt.json",
                "effect_allowed": False,
            },
        ],
        "pr_2058_review_decision": {
            "pull_request_ref": "github://tamirat-wubie/mullu-control-plane/pull/2058",
            "decision": "hold_open_do_not_merge",
            "state_observed": "open_mergeable_awaiting_external_workflow_evidence",
            "merge_allowed": False,
            "close_allowed": False,
            "reason": (
                "PR #2058 remains no-effect governance evidence while remote workflow "
                "and signed runtime authorization evidence are AwaitingEvidence."
            ),
            "issue_2067_decision_satisfied": True,
        },
        "inceptadive_advisory_panel": {
            "panel_id": "redacted_inceptadive_advisory_demo",
            "status": "redacted_advisory_only",
            "redacted": True,
            "advisory_only": True,
            "execution_authority_allowed": False,
            "source_refs": [
                "mcoi/mcoi_runtime/core/phi_inceptadive_bridge.py",
                "tests/test_phi_inceptadive_bridge.py",
            ],
            "visible_findings": [
                "missing_live_connector_evidence_blocks_effects",
                "approval_preview_is_not_execution",
                "dry_run_receipts_are_not_terminal_closure",
            ],
        },
        "deterministic_replay": {
            "replay_id": "team_assistant_demo_fixture_replay_v0",
            "source": "checked_in_fixtures",
            "fixture_refs": fixture_refs,
            "replay_steps": [
                "load_dashboard_projection_fixture",
                "load_readiness_projection",
                "load_draft_preview_fixture",
                "load_approval_preview_fixture",
                "load_dry_run_receipts",
                "assert_all_effect_flags_false",
            ],
            "external_calls_allowed": False,
            "filesystem_writes_allowed": False,
            "live_receipt_append_allowed": False,
            "deterministic_replay_from_fixtures": True,
        },
        "approval_authority_next_phase": {
            "phase_id": "signed_approval_authority_v1_design",
            "status": "AwaitingEvidence",
            "signed_operator_identity_required": True,
            ...
            "execution_authority_granted_by_demo": False,
        },
        "execution_allowed": False,
        "live_connector_execution_allowed": False,
        "external_send_allowed": False,
