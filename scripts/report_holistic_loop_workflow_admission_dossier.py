...
DOSSIER_ID = "holistic_loop_workflow_admission_dossier"
DOSSIER_VERSION = "holistic_loop_workflow_admission_dossier.v1"
CANDIDATE_ID = "workflow_execution_loop"
ADMISSION_STATUS_READY = "ready_for_operator_decision"


def _workflow_candidate() -> Any:
...
def validate_dossier(dossier: dict[str, Any] | None = None) -> list[str]:
    """Return validation errors for the workflow admission dossier."""
...
def main(argv: list[str] | None = None) -> int:
    """Emit the workflow admission dossier."""

    parser = argparse.ArgumentParser(description="Report the workflow holistic loop admission dossier.")
