...
REQUIRED_PLAN_TERMS = (
    ...
    "durable_gmail_account_binding_operator_input_request.schema.json",
    "emit_durable_gmail_account_binding_operator_input_request.py",
    "validate_durable_gmail_account_binding_operator_input_request.py",
    ...
    "durable_gmail_live_write_operator_input_request.schema.json",
    "emit_durable_gmail_live_write_operator_input_request.py",
    "validate_durable_gmail_live_write_operator_input_request.py",
    "Evidence freshness",
    "source live receipt",
...
def build_validation_report() -> dict[str, Any]:
    ...
    checks = (
        ...
        "durable_gmail_account_binding_operator_input_request",
        "durable_gmail_account_binding",
        "durable_gmail_write_authority_rehearsal",
        "durable_gmail_live_write_operator_input_request",
