...
def _action_for(adapter_id: str, blocker: str) -> AdapterClosureAction:
    ...
    if blocker == "browser_live_evidence_missing":
        return _receipt_action(
            adapter_id,
            blocker,
            "python scripts/produce_capability_adapter_live_receipts.py --target browser --browser-sandbox-evidence <sandbox_receipt_ref> --strict",
            ("browser_live_receipt.json", "sandbox_receipt_ref"),
        )
