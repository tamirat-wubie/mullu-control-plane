    ...
    surfaces = [
        ...
        _surface(
            ...
            [
                ...
                "/api/v1/components/capability-governance",
            ],
            "read_model",
            "read_model",
            "audit_chain",
            ...
            [
                ...
                "docs/76_capability_passport_dashboard.md",
                "schemas/capability_debt_report.schema.json",
                "schemas/capability_passport_dashboard.schema.json",
                "schemas/component_read_model.schema.json",
                "examples/capability_debt_report.foundation.json",
                "examples/capability_passport_dashboard.foundation.json",
                ...
                "tests/test_validate_capability_debt_report.py",
                "tests/test_validate_capability_passport_dashboard.py",
                "tests/test_validate_component_read_model.py",
            ],
            "Component Harness read model joins registry, router inventory, proof binding, and capability governance dashboard/debt projections into bounded read-only operator surfaces with live execution, connector send, mutation, and terminal closure authority denied.",
            [
                "component_read_model_builds_registry_router_proof_projection",
                "component_read_model_route_is_read_only",
                "capability_governance_read_model_route_is_selectable_and_read_only",
        ...
        _surface(
            ...
            [
                ...
                "tests/test_collect_personal_assistant_skill_readiness_catalog.py",
                "tests/test_validate_personal_assistant_skill_readiness_catalog.py",
                "tests/test_collect_personal_assistant_dry_run_packet.py",
                "tests/test_validate_personal_assistant_dry_run_packet.py",
                ...
                "examples/personal_assistant_skill_readiness_catalog.json",
                "examples/personal_assistant_dry_run_packet.json",
                ...
                "scripts/collect_personal_assistant_skill_readiness_catalog.py",
                "scripts/validate_personal_assistant_skill_readiness_catalog.py",
                "scripts/collect_personal_assistant_dry_run_packet.py",
                "scripts/validate_personal_assistant_dry_run_packet.py",
            ...
            [
                ...
                "personal_assistant_skill_readiness_catalog_no_effect",
                "personal_assistant_dry_run_packet_no_effect",
            ],
            runtime_witness_anchor_aliases={
                "assistant_profiles_read_model_bounded": [
                ...
                "personal_assistant_approval_review_packet_public_safe": [
                    "personal_assistant_approval_review_packet_fixture_validates",
                    "approval_review_packet_validator_rejects_authority_drift",
                    "approval_review_packet_validator_rejects_missing_evidence_forbidden_or_checks",
                    "approval_review_packet_validator_rejects_raw_payload_and_secret",
                    "p4_approval_proposal_review_packet_matches_schema_and_denies_effects",
                    "p5_approval_proposal_review_packet_requires_public_boundary_check",
                ...
                "personal_assistant_skill_readiness_catalog_no_effect": [
                    "skill_readiness_catalog_closes_from_checked_in_evidence",
                    "skill_readiness_catalog_blocks_missing_lane_binding",
                    "skill_readiness_catalog_blocks_authority_coverage_drift",
                    "skill_readiness_catalog_blocks_p4_approval_drift",
                    "validation_accepts_schema_valid_closed_catalog",
                    "validation_rejects_lane_drift",
                    "validation_rejects_execution_overclaim",
                    "validation_rejects_p4_approval_drift",
                    "validation_rejects_secret_shaped_values",
                ],
                "personal_assistant_dry_run_packet_no_effect": [
                    "collect_dry_run_packet_closes_no_effect_workflow",
                    "collect_dry_run_packet_records_approval_before_external_send",
                    "collect_dry_run_packet_no_effect_boundary_denies_live_authority",
                    "validate_dry_run_packet_accepts_checked_in_shape",
                    "validate_dry_run_packet_rejects_ungated_p4_path",
                    "validate_dry_run_packet_rejects_secret_values",
                ],
            },
        ),
        _surface(
        ...
        _surface(
            ...
            [
                ...
                "mcoi/mcoi_runtime/core/operator_console_first_read_model.py",
                ...
                "mcoi/tests/test_operator_console_first_read_model.py",
            ...
            "Operator console routes expose bounded read-only runtime, audit, checkpoint, provider, scheduler, shadow posture, note-memory, personal-assistant lane-status, Operator Console First panels, spatial governance panels, HTML views, and aggregate views with governed response witnesses.",
            [
        ...
        _surface(
            ...
            "InceptaDive shadow inspection routes expose bounded advisory results, redacted request ids, redacted receipts, replayed redacted external-effect advisory history, and assistant planning hook metadata without execution authority, raw request text exposure, unsafe caller-id exposure, or private memory exposure.",
            [
                "shadow_inspect_route_runs_runtime_and_redacts_raw_text",
                "shadow_inspect_route_redacts_secret_shaped_request_id",
                ...
                "external_effect_advisory_route_redacts_secret_shaped_request_id",
        ...
        _surface(
            "inceptadive_assistant_response_embedding",
            [
                "/api/v1/chat",
                "/api/v1/chat/stream",
            ...
            "proven",
            [
                "mcoi/mcoi_runtime/app/inceptadive_assistant_response_embedding.py",
                "mcoi/mcoi_runtime/app/routers/llm/chat.py",
        ...
        _surface(
            ...
            [
                ...
                "closure_packet_drift_operator_action_binds_accepted_risk_runbook_remediation",
        ...
        _surface(
            "maf_failure_receipt_path_witness",
            [
                "MafFailureReceiptPathWitness",
                "validate_maf_failure_receipt_path_witness",
                "maf_failure_receipt_path_witness.v1",
            ],
            "request_proof",
            "action_proof",
            "audit_chain",
            ...
            "MAF failure receipt path witnesses bind static failure materialization path descriptor digests for verify-receipt-chain, verify-kernel-proof, and emit-transition-receipt while keeping runtime binding, command behavior, CLI execution, subprocess execution, Rust execution, PyO3, connector calls, writes, raw failure payload retention, runtime dispatch, terminal closure, and success claims denied.",
            [
                "maf_failure_receipt_path_witness_schema_valid",
                "maf_failure_receipt_path_witness_denies_execution",
                "maf_failure_receipt_path_witness_requires_failure_path_controls",
                "maf_failure_receipt_path_witness_rejects_control_drift",
                "maf_failure_receipt_path_witness_rejects_digest_and_summary_drift",
                "maf_failure_receipt_path_witness_sdlc_artifacts_valid",
            ],
            runtime_witness_anchor_aliases={
                "maf_failure_receipt_path_witness_schema_valid": [
                    "maf_failure_receipt_path_witness_passes"
                ],
                "maf_failure_receipt_path_witness_denies_execution": [
                    "maf_failure_receipt_path_witness_passes",
                    "maf_failure_receipt_path_rejects_authority_drift",
                ],
                "maf_failure_receipt_path_witness_requires_failure_path_controls": [
                    "maf_failure_receipt_path_witness_passes",
                    "maf_failure_receipt_path_rejects_scope_and_future_drift",
                ],
                "maf_failure_receipt_path_witness_rejects_control_drift": [
                    "maf_failure_receipt_path_rejects_control_drift"
                ],
                "maf_failure_receipt_path_witness_rejects_digest_and_summary_drift": [
                    "maf_failure_receipt_path_rejects_digest_and_summary_drift"
                ],
                "maf_failure_receipt_path_witness_sdlc_artifacts_valid": [
