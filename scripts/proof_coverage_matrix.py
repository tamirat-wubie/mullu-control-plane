...
def proof_coverage_matrix() -> dict[str, Any]:
    ...
    surfaces = [
        ...
        _surface(
            ...
            "Webhook operations routes bind subscription creation, subscription listing, delivery history, retry summary, and dead-letter read models to governed metrics, audit records, and bounded webhook manager state.",
            [
    ...
    closure_actions = [
        ...
        {
            "action_id": "classify_webhook_operations_lifecycle_routes",
            "surfaces": ["webhook_operations_lifecycle"],
            "status": "closed",
        },
        {
