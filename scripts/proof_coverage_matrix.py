...
def proof_coverage_matrix() -> dict[str, Any]:
    ...
    surfaces = [
        ...
        _surface(
            ...
            "Operational health routes expose bounded read models for deep component diagnostics, weighted health score, optional extension posture, shadow posture, degraded-state checks, and v3 recovery tracking without mutation authority.",
            [
        ...
        _surface(
            ...
            "OrgOS lifecycle routes register organization authority, departments, governed cases, evidence events, plan gates, closure decisions, replayed read models, proof timelines, and bounded worker dispatch receipts as plan-step evidence without holding worker dispatch authority.",
            [
