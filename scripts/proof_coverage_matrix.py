...
def proof_coverage_matrix() -> dict[str, Any]:
    ...
    surfaces = [
        ...
        _surface(
            ...
            [
                ...
                "multi_agent_merge_decision_explicit",
                "multi_agent_conflict_recorded_for_resolution",
                "multi_agent_unresolved_conflicts_bounded_read_model",
    ...
    closure_actions = [
        ...
        },
        {
            ...
            "surfaces": ["multi_agent_coordination"],
            "status": "closed",
        },
        {
