...
def proof_coverage_matrix() -> dict[str, Any]:
    ...
    surfaces = [
        ...
        _surface(
            ...
            "OrgOS lifecycle routes register organization authority, departments, governed cases, evidence events, plan gates, closure decisions, replayed read models, proof timelines, proof explorer projections, and bounded worker dispatch receipts as plan-step evidence without holding worker dispatch authority.",
            [
