...
def proof_coverage_matrix() -> dict[str, Any]:
    ...
    surfaces = [
        ...
        _surface(
            ...
            "Governed operational intelligence binds sourced world-state admission, knowledge graph entity/link/contradiction routes, compiled goal-plan certificates, and deterministic causal simulation receipts before effect-bearing execution.",
            [
