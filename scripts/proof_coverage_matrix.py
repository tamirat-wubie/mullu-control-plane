...
def proof_coverage_matrix() -> dict[str, Any]:
    ...
    surfaces = [
        ...
        _surface(
            ...
            "witnessed",
            [
                "docs/19_skill_system.md",
                "mcoi/mcoi_runtime/app/routers/runbooks.py",
                "mcoi/mcoi_runtime/core/runbook_learning.py",
                "mcoi/mcoi_runtime/core/runbook.py",
                "mcoi/tests/test_runbook_learning.py",
                "mcoi/tests/test_runbook.py",
            ],
            "Runbook learning routes analyze audited patterns, promote candidates, require operator approval before activation, reject invalid lifecycle transitions, sanitize public errors, and expose bounded read models.",
            [
                "runbook_pattern_analysis_endpoint",
                "runbook_promotion_creates_candidate",
                "operator_approval_required_before_activation",
                "active_runbook_required_before_retirement",
                "runbook_errors_are_sanitized",
                "runbook_summary_read_model",
            ],
        ),
        _surface(
            "pilot_provisioning",
        ...
        _surface(
            ...
            "Runtime conformance certificate binds live witness, closure, fabric, isolation, lineage, authority, MCP manifest validity, proof-matrix route classification summary, document-drift checks, issuer schema self-validation, and collector schema validation into one signed attestation.",
            [
    ...
    closure_actions = [
        ...
        {
            "action_id": "classify_runbook_learning_api",
            "surfaces": ["runbook_learning_api"],
            "status": "closed",
        },
        {
