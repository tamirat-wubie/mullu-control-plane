...
def proof_coverage_matrix() -> dict[str, Any]:
    ...
    surfaces = [
        ...
        _surface(
            ...
            "Runtime witness surfaces publish bounded operational and responsibility debt state; orchestration receipts bind ingress render, MCP checklist validation, preflight, and dispatch evidence before deployment witness readiness.",
            [
