...
def proof_coverage_matrix() -> dict[str, Any]:
    ...
    surfaces = [
        ...
        _surface(
            ...
            "Runtime Reflex surfaces expose operator-gated health, anomaly, diagnosis, eval, proposal, certification handoff, promotion decision, signed witness projections, and schema-backed offline witness replay without direct runtime mutation.",
            [
