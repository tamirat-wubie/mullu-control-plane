...
def _validate_terminal_closure_generic_continuation_rejection_semantics(
    ...
    if source_decision_contract:
        ...
        for evidence_key in COMMAND_PREVIEW_CERTIFICATE_CANDIDATE_EVIDENCE_KEYS:
            _require_equal(
                payload,
                (
                    "continuation_rejection",
                    "command_preview_decision_contract_evidence",
                    "command_preview_certificate_candidate_evidence",
                    evidence_key,
                ),
                _get_nested(
                    source_decision_contract,
                    ("decision_contract", "command_preview_certificate_candidate_evidence", evidence_key),
                ),
                errors,
                label,
            )
