...
def _project_approval(gate: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "approval_request_ref": gate["approval_request_ref"],
        "gateway_approval_ref": gate["gateway_approval_ref"],
        "run_id": gate["run_id"],
        ...
        "requested_evidence_ref": gate["requested_evidence_ref"],
        "response_record_required": gate["response_record_required"],
