...
def _build_submission_receipt(
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "anchor_artifact_root_hash": str(anchor_receipt["artifact_root_hash"]),
        "anchor_artifact_count": int(anchor_receipt["artifact_count"]),
...
def _verify_remote_preflight_receipt(
    *,
    ...
    required_matches = (
        ...
        ("anchor_artifact_root_hash", preflight["anchor_artifact_root_hash"], payload["anchor_artifact_root_hash"]),
        ("anchor_artifact_count", int(preflight["anchor_artifact_count"]), payload["anchor_artifact_count"]),
...
def _remote_preflight_receipt_id(preflight: dict[str, Any]) -> str:
    ...
    receipt_seed = {
        ...
        "anchor_artifact_root_hash": str(preflight["anchor_artifact_root_hash"]),
        "anchor_artifact_count": int(preflight["anchor_artifact_count"]),
