    ...
    *,
    ...
    payload = {
        ...
        "sandbox_profile": {
            ...
            "seccomp_profile": receipt_payload["seccomp_profile_applied"],
        ...
        "isolation": {
            "network_disabled": receipt_payload["network_disabled"],
            "read_only_rootfs": receipt_payload["read_only_rootfs"],
            "capabilities_dropped": receipt_payload["capabilities_dropped"],
            "seccomp_profile_applied": receipt_payload["seccomp_profile_applied"],
            "workspace_mount": receipt_payload["workspace_mount"],
            "forbidden_effects_observed": receipt_payload["forbidden_effects_observed"],
            "changed_file_count": receipt_payload["changed_file_count"],
            "changed_file_refs": list(receipt_payload["changed_file_refs"]),
        },
        "probe": {
