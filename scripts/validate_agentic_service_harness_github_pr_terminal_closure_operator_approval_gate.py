...
def _validate_terminal_closure_operator_approval_gate_semantics(
    ...
    if source_candidate:
        ...
        for key in COMMAND_PREVIEW_CERTIFICATE_CANDIDATE_EVIDENCE_KEYS:
            _require_equal(
                payload,
                ("approval_gate", "command_preview_certificate_candidate_evidence", key),
                _get_nested(source_candidate, ("command_preview_terminal_closure_certificate_evidence", key)),
                errors,
                label,
            )
