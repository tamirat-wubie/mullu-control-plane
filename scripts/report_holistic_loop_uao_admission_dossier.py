...
Orchestration loop candidate and its registry admission state.
...
Invariants:
  ...
  - The dossier does not mutate the UAO loop registration.
...
def build_dossier() -> dict[str, Any]:
    ...
    return {
        ...
        "operator_decision_report": {
            ...
            "decision_ref": (
                "default_registry:universal_action_orchestration_loop"
                if registered
                else ""
            ),
