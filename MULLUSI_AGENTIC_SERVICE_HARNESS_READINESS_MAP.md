...
Current `origin/main`: `79a9ce58fab1530fb651fd7e5e7990ce00d86ade`

Open PRs after readiness-map refresh: the external PR queue remains outside this PR effect reconciliation readiness-map closure; the queue is live, may change after this branch, and does not grant harness execution authority.
...
| Open PR queue | PARTIAL | External open PRs remain outside this PR effect reconciliation readiness-map closure; the queue is live, may change after this branch, and does not grant harness execution authority. |
...
| PR creation after approval only | READY | Open-PR awaiting approval examples, GitHub PR admission preflight, GitHub PR CI gate before ready-for-review witness, effect reconciliation evidence surfaces, and terminal closure candidate/operator decision gates exist. They keep PR admission denied unless operator approval, branch-write authority, UAO admission, rollback, CI evidence, and effect reconciliation evidence exist, and they grant no branch, PR, ready-for-review, repository, connector, network, mutation-route, receipt-store, secret, destructive, or terminal authority. | None for admission, CI-gate witness, effect reconciliation evidence, or terminal closure candidate gates. Live PR creation remains blocked until explicit operator decision value and certificate minting evidence exist. |
