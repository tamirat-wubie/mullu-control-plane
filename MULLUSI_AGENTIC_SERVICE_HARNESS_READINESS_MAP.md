...
2. `harness(pr): mint PR terminal closure certificate after approved decision value`
...
STATUS:
  ...
  Next action: collect an explicit approved/denied PR terminal closure decision value before any terminal certificate minting
