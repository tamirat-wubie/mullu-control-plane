...
Current `origin/main`: `3c5c1e9eae38cf44f52b80a1e836349ec2eac546`

Open PRs after readiness-map refresh: the external PR queue remains outside this non-empty diff receipt admission preflight closure; the queue is live, may change after this branch, and does not grant harness execution authority.
...
| Remote CI | READY | `origin/main` is verified at `3c5c1e9eae38cf44f52b80a1e836349ec2eac546`; this non-empty diff receipt admission preflight branch requires current PR CI before merge. |
...
| Open PR queue | PARTIAL | External open PRs remain outside this non-empty diff receipt admission preflight closure; the queue is live, may change after this branch, and does not grant harness execution authority. |
...
2. `harness(pr): bind PR ready-for-review CI evidence`
