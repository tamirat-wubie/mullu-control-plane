...
Current `origin/main`: `6248799d51f895475a9c5eafab436891806cb45f`
...
| Remote CI | READY | `origin/main` is verified at `6248799d51f895475a9c5eafab436891806cb45f`; this terminal closure readiness-map branch requires current PR CI before merge. |
...
| PR creation after approval only | READY | Open-PR awaiting approval examples, GitHub PR admission preflight, GitHub PR CI gate before ready-for-review witness, effect reconciliation evidence surfaces, and non-authorizing terminal closure certificate/gate/decision/rejection surfaces exist. They keep PR admission denied unless operator approval, branch-write authority, UAO admission, rollback, CI evidence, effect reconciliation evidence, explicit terminal decision value, and terminal certificate evidence exist, and they grant no branch, PR, ready-for-review, repository, connector, network, mutation-route, receipt-store, secret, destructive, or terminal authority. | None for admission, CI-gate witness, effect reconciliation evidence, or non-authorizing terminal closure chain. Live PR creation remains blocked until an explicit operator decision and terminal closure certificate are minted through a governed path. |
...
2. `harness(pr): mint PR terminal closure certificate after approval`
