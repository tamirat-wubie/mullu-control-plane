...
Current `origin/main`: `3a643623b89f413fe74c92b68982cea0941114de`

Open PRs after readiness-map refresh: PR #2158, PR #2159, PR #2160, and PR #2162 remain open outside this receipt-store append preflight closure; the queue is live, may change after this branch, and remains outside this map-only closure.
...
| Remote CI | READY | `origin/main` is verified at `3a643623b89f413fe74c92b68982cea0941114de`; this receipt-store append preflight branch requires current PR CI before merge. |
...
| Open PR queue | PARTIAL | PR #2158, PR #2159, PR #2160, and PR #2162 remain open outside this receipt-store append preflight closure; the queue is live, may change after this branch, and does not grant harness execution authority. |
