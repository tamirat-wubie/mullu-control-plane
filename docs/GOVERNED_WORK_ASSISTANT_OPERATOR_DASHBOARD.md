...
This dashboard schema is intentionally a local docs contract, not a public protocol schema. If it later needs broader publication, promote it through a dedicated compatibility PR.
