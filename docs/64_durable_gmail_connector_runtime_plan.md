...
14. Run live approval-gated send/draft evidence only if write operations are in scope and an approval receipt exists.
15. Update release readiness only after all receipts pass.
