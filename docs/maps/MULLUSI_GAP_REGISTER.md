...
```text
The register confirms that product UI, durable interpretation, search cost controls, live runtime receipt schema-binding activation, live receipt-store write path, and channel hardening are still not closed.
```
