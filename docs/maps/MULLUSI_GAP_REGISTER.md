...
3. Draft channel trust and approval-strength policy.
...
```text
The register confirms that channel hardening, source-level search freshness evidence, channel approval-strength policy, and admin surfaces are still not closed.
```
