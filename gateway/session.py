...
class SessionManager:
    ...
    def add_message(self, channel: str, sender_id: str, role: str, content: str) -> None:
    ...
    def get_context(self, channel: str, sender_id: str) -> ConversationContext | None:
        """Get existing context without creating."""
        return self._contexts.get(self._key(channel, sender_id))

    def clear_context(self, channel: str, sender_id: str) -> bool:
        """Clear a conversation context (e.g., user says 'new conversation')."""
        key = self._key(channel, sender_id)
