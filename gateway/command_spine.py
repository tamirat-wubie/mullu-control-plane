...
class CommandState(StrEnum):
    ...
    AUTHORITY_PATH_BUILT = "authority_path_built"
    APPROVAL_CHAIN_PENDING = "approval_chain_pending"
    APPROVAL_CHAIN_SATISFIED = "approval_chain_satisfied"
    ...
    OBLIGATIONS_ESCALATED = "obligations_escalated"
...
_CAPABILITY_PASSPORTS: dict[str, CapabilityPassport] = {
    ...
    "creative.document_generate": CapabilityPassport(
        capability="creative.document_generate",
        version="1",
        risk_tier="medium",
        input_schema="CreativeDocumentGenerateIntent.v1",
        output_schema="CreativeDocumentReceipt.v1",
        authority_required=("operator",),
        requires=("tenant_bound", "budget_reserved", "idempotency_key"),
        mutates_world=False,
        external_system="",
        rollback_type="irreversible",
        proof_required_fields=("document_id", "content_hash"),
        declared_effects=("document_artifact_generated",),
        forbidden_effects=("external_message_sent", "file_written", "payment_created"),
        evidence_required=("document_id", "content_hash"),
        graph_projection={
            "nodes": ("command", "provider_action", "verification", "evidence"),
            "edges": ("verified_by", "produced"),
        },
    ),
    "creative.data_analyze": CapabilityPassport(
        capability="creative.data_analyze",
        version="1",
        risk_tier="low",
        input_schema="CreativeDataAnalyzeIntent.v1",
        output_schema="CreativeDataAnalysisReceipt.v1",
        authority_required=("operator",),
        requires=("tenant_bound", "budget_reserved", "idempotency_key"),
        mutates_world=False,
        external_system="",
        rollback_type="irreversible",
        proof_required_fields=("row_count", "column_count"),
        declared_effects=("data_analysis_generated",),
        forbidden_effects=("external_message_sent", "file_written", "payment_created"),
        evidence_required=("row_count", "column_count"),
        graph_projection={
            "nodes": ("command", "provider_action", "verification", "evidence"),
            "edges": ("verified_by", "produced"),
        },
    ),
    "creative.translate": CapabilityPassport(
        capability="creative.translate",
        version="1",
        risk_tier="low",
        input_schema="CreativeTranslateIntent.v1",
        output_schema="CreativeTranslateReceipt.v1",
        authority_required=("operator",),
        requires=("tenant_bound", "budget_reserved", "idempotency_key"),
        mutates_world=False,
        external_system="",
        rollback_type="irreversible",
        proof_required_fields=("translation_prompt", "target_lang"),
        declared_effects=("translation_prompt_prepared",),
        forbidden_effects=("external_message_sent", "file_written", "payment_created"),
        evidence_required=("translation_prompt", "target_lang"),
        graph_projection={
            "nodes": ("command", "provider_action", "verification", "evidence"),
            "edges": ("verified_by", "produced"),
        },
    ),
    "enterprise.knowledge_search": CapabilityPassport(
        capability="enterprise.knowledge_search",
        version="1",
        risk_tier="low",
        input_schema="EnterpriseKnowledgeSearchIntent.v1",
        output_schema="EnterpriseKnowledgeSearchReceipt.v1",
        authority_required=("operator",),
        requires=(
            "tenant_bound",
            "provider_scope",
        ...
        rollback_type="irreversible",
        proof_required_fields=("total_chunks_searched",),
        declared_effects=("knowledge_chunks_read",),
        forbidden_effects=("cross_tenant_read", "file_written", "payment_created"),
        evidence_required=("total_chunks_searched", "search_decision_receipt"),
        cost_model={"max_estimated_cost": 1.0, "unit": "search_cost_unit"},
        graph_projection={
            "nodes": ("command", "provider_action", "verification"),
            "edges": ("verified_by", "produced"),
        },
    ),
    "enterprise.notification_send": CapabilityPassport(
        ...
        compensation_capability="enterprise.notification_correction",
        proof_required_fields=("receipt_status",),
        declared_effects=("notification_sent",),
        forbidden_effects=("payment_created", "file_written", "cross_tenant_message"),
        evidence_required=("receipt_status",),
        graph_projection={
            "nodes": ("command", "provider_action", "verification", "evidence"),
            "edges": ("verified_by", "produced"),
        },
    ),
    "enterprise.task_schedule": CapabilityPassport(
        capability="enterprise.task_schedule",
        version="1",
        risk_tier="medium",
        input_schema="EnterpriseTaskScheduleIntent.v1",
        output_schema="EnterpriseTaskScheduleReceipt.v1",
        authority_required=("operator",),
        requires=("tenant_bound", "budget_reserved", "idempotency_key"),
        mutates_world=True,
        external_system="database",
        rollback_type="reversible",
        rollback_capability="enterprise.task_cancel",
        proof_required_fields=("task_id",),
        declared_effects=("task_scheduled",),
        forbidden_effects=("payment_created", "external_email_sent", "cross_tenant_write"),
        evidence_required=("task_id",),
        graph_projection={
            "nodes": ("command", "provider_action", "verification", "evidence"),
            "edges": ("verified_by", "produced"),
        },
