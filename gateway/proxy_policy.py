"""Gateway proxy usage policy.

Purpose: bound process-level HTTP proxy environment variables before gateway
    network transports can use them implicitly.
Governance scope: outbound gateway transports, proxy credential redaction, and
