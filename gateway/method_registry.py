...
STARTER_CAPSULES: tuple[MethodCapsule, ...] = (
    ...
    _starter(
        ...
        failure_modes=(
            "hallucinated steps",
            "non-reproducible without fixed seed/model",
            "prompt injection via untrusted goal/context text",
        ),
        cost_class="medium",
        explainability="low",
        risk_ceiling="medium",
    ...
    _starter(
        ...
        failure_modes=(
            ...
            "over-flags style as defects",
            "prompt injection via untrusted artifact text",
        ),
        cost_class="medium",
        explainability="medium",
        risk_ceiling="medium",
    ...
    _starter(
        ...
        failure_modes=(
            "agreement collusion",
            "cost grows with rounds",
            "prompt injection / adversarial input steers the debate",
        ),
        cost_class="high",
        explainability="medium",
        risk_ceiling="medium",
    ...
    _starter(
        ...
        failure_modes=(
            "review latency",
            "rubber-stamping",
            "no qualified reviewer available (escalation unavailable)",
        ),
        cost_class="high",
        explainability="high",
        risk_ceiling="physical",
