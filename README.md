...
Per-release detail in `RELEASE_NOTES_v4.0.0.md` through `RELEASE_NOTES_v4.47.0.md` at repo root. These v4.x files are mainline implementation and hardening records, while the current GitHub latest-release witness remains `v3.13.3`.
